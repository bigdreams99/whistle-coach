...
function InstallBanner({ deferredPrompt, promptInstall, onDismiss }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1 }}>
        <div style={{ fontSize: 14, fontWeight: 600, color: c.slate800 }}>Install Whistle Coach</div>
...
const soccerDrillsFull = [
  ...
  // ── ADVANCED GOALKEEPER ──────────────────────────────────────────
  { id: "gk6", name: "1v1 Shot Stopping", phase: "technical", focus: ["goalkeeping"], ages: [10,11,12,13,14], duration: 10, players: [2,6], equipment: ["balls", "goals", "cones"], description: "Attacker dribbles toward goal from 25 yards. GK must read the play, advance off the line, set, and make themselves big. Rotate attackers. Progress from straight runs to angled approaches.", coaching: ["Advance quickly but set before the shot", "Stay on your feet as long as possible", "Make yourself big — spread arms and legs", "If they take a touch wide, attack the ball"], category: "technical", skills: ["Goalkeeping","1v1","Positioning"], intensity: "high" },
  { id: "gk7", name: "Back-Pass & Distribution", phase: "technical", focus: ["goalkeeping", "passing"], ages: [10,11,12,13,14], duration: 8, players: [3,8], equipment: ["balls", "goals", "cones"], description: "GK receives back passes and must play out under pressure. Defenders pass back, GK has 3 seconds to distribute. Add an attacker pressing to simulate game pressure.", coaching: ["Take position early to give yourself time", "Decide before the ball arrives: play or clear", "Short pass to the open side", "Communication: call for the ball or wave it wide"], category: "technical", skills: ["Goalkeeping","Distribution","Decision Making"], intensity: "medium" },
  { id: "gk8", name: "Reaction Saves Circuit", phase: "technical", focus: ["goalkeeping"], ages: [9,10,11,12,13,14], duration: 8, players: [1,4], equipment: ["balls", "goals", "cones"], description: "GK faces away. On whistle, turns and reacts to a shot from 8 yards. Variations: sit-up start, push-up start, jump-and-save. Three rapid shots in sequence from different angles.", coaching: ["Get set as fast as possible after turning", "Stay balanced on the balls of your feet", "React with hands first — dive second", "Reset quickly between shots"], category: "technical", skills: ["Goalkeeping","Reactions","Agility"], intensity: "high" },

  // ── ADDITIONAL SET PIECES ───────────────────────────────────────
  { id: "sp4", name: "Defensive Set Piece Organization", phase: "tactical", focus: ["defending"], ages: [11,12,13,14], duration: 10, players: [8,16], equipment: ["balls", "goals", "cones"], description: "Practice defending corners and free kicks. Assign man-marking or zonal responsibilities. GK commands the box. Run 10 set pieces, track how many the defense wins.", coaching: ["Everyone has an assignment — know yours", "Attack the ball, don't wait for it", "GK: organize before the kick", "First header must be away from goal"], category: "tactical", skills: ["Defending","Set Pieces","Communication"], intensity: "medium" },
  { id: "sp5", name: "Quick Free Kick Routine", phase: "tactical", focus: ["attacking", "transition"], ages: [10,11,12,13,14], duration: 8, players: [6,16], equipment: ["balls", "goals", "cones"], description: "Practice taking quick free kicks before the defense is set. One player stands over the ball as a decoy while another runs and plays it quickly. Three rehearsed patterns from different zones.", coaching: ["Awareness — look up immediately after the foul", "Pre-planned signals between kicker and runners", "Speed of execution is everything", "If the defense is set, slow down and run a routine"], category: "tactical", skills: ["Set Pieces","Attacking","Decision Making"], intensity: "medium" },

  // ── ADVANCED TACTICAL ───────────────────────────────────────────
  { id: "ta17", name: "Build from the Back (GK+4)", phase: "tactical", focus: ["possession", "passing"], ages: [11,12,13,14], duration: 12, players: [8,16], equipment: ["cones", "bibs", "goals"], description: "GK and 4 defenders build out against 2-3 pressers. Find the free player through short passes. Progress: add midfield targets to play into. If press is beaten, attack the opposite goal.", coaching: ["GK starts the play — set the tempo", "Split the press with a pass between them", "If pressed hard, go long and don't risk it", "CBs spread wide, fullbacks push high"], category: "tactical", skills: ["Possession","Passing","Build-Up Play"], intensity: "medium" },
  { id: "ta18", name: "Wing Play & Crossing", phase: "tactical", focus: ["attacking", "shooting"], ages: [10,11,12,13,14], duration: 12, players: [8,16], equipment: ["cones", "bibs", "goals"], description: "Full-width attack drill. Wide players receive, dribble to the byline, and deliver crosses. Central players make near-post, far-post, and pull-back runs. Rotate positions.", coaching: ["Wide players: get to the byline before crossing", "Attackers: stagger your runs — near, middle, far", "Delivery: low and hard for near post, lofted for far", "Third attacker arrives late at the edge of the box"], category: "tactical", skills: ["Attacking","Crossing","Movement"], intensity: "high" },
  { id: "ta19", name: "High Press Activation", phase: "tactical", focus: ["defending", "transition"], ages: [12,13,14], duration: 12, players: [10,22], equipment: ["cones", "bibs", "goals"], description: "Full-team pressing exercise. Defending team starts in a high block and presses on trigger (GK pass, sideways pass). If they win the ball, immediate attack on goal. Rotate every 5 minutes.", coaching: ["Press as a unit — not just one player", "Cut off the easy pass before pressing the ball", "Win it back in 5 seconds or drop", "Transition to attack instantly on the turnover"], category: "tactical", skills: ["Defending","Pressing","Transition"], intensity: "high" },

  // ── MORE GAME VARIATIONS ───────────────────────────────────────
  { id: "g8", name: "Target Player Game", phase: "game", focus: ["possession", "passing"], ages: [9,10,11,12,13,14], duration: 15, players: [10,22], equipment: ["cones", "bibs"], description: "5v5 with a target player for each team standing in an end zone. Score by playing the ball into your target player. Target plays one touch and the ball must come back before you can score again.", coaching: ["Look to play forward early", "Movement off the ball to create passing lanes", "Switch play when one side is blocked", "Target: show for the ball, don't hide"], category: "tactical", skills: ["Possession","Passing","Vision"], intensity: "high" },
  { id: "g9", name: "Futsal-Style 4v4", phase: "game", focus: ["decision making", "1v1", "fun"], ages: [8,9,10,11,12,13,14], duration: 15, players: [8,16], equipment: ["cones", "goals"], description: "4v4 on a tight futsal-sized pitch. No throw-ins — kick-ins only. Emphasizes quick feet, tight control, and rapid combinations in small spaces. 5-minute halves.", coaching: ["Constant movement — no standing", "Quick passing and 1-2s", "Use the sole of your foot to control", "Defend as a unit — no ball watching"], category: "tactical", skills: ["Decision Making","1v1","Technique"], intensity: "high" },
  { id: "g10", name: "Possession Points Game", phase: "game", focus: ["possession", "decision making"], ages: [10,11,12,13,14], duration: 15, players: [10,22], equipment: ["cones", "bibs", "goals"], description: "Normal game but with a twist: teams earn 1 point for a goal, but also 1 point for completing 8 consecutive passes. Encourages patient build-up alongside direct play.", coaching: ["Keep possession when the chance isn't on", "Play forward when you see the opportunity", "Count out loud as a team to track passes", "Both strategies matter — balance risk and reward"], category: "tactical", skills: ["Possession","Decision Making","Teamwork"], intensity: "high" },
];
...
const cardStyle = {
  ...
  overflow: "hidden", transition: "box-shadow 0.25s ease, transform 0.2s ease", cursor: "pointer",
...
function PageHero({ title, subtitle, actions, gradient }) {
  return (
    <div className="whistle-hero" style={{ background: gradient || `linear-gradient(135deg, ${c.green800} 0%, ${c.green600} 100%)`, borderRadius: 20, padding: "36px 40px", color: c.white, position: "relative", overflow: "hidden", marginBottom: 28, boxShadow: "0 4px 20px rgba(0,0,0,0.12)" }}>
      <div style={{ position: "absolute", top: -40, right: -20, width: 200, height: 200, borderRadius: "50%", background: "rgba(255,255,255,0.07)" }} />
      <div style={{ position: "absolute", bottom: -60, right: 80, width: 160, height: 160, borderRadius: "50%", background: "rgba(255,255,255,0.05)" }} />
      <div style={{ position: "absolute", top: 20, right: 40, width: 80, height: 80, borderRadius: "50%", background: "rgba(255,255,255,0.03)" }} />
      <div style={{ position: "absolute", bottom: 10, left: "40%", width: 120, height: 120, borderRadius: "50%", background: "rgba(255,255,255,0.02)" }} />
      <h1 style={{ fontSize: 28, fontWeight: 800, marginBottom: 8, position: "relative", letterSpacing: -0.5 }}>{title}</h1>
      <p style={{ fontSize: 15, opacity: 0.85, marginBottom: actions ? 22 : 0, maxWidth: 520, lineHeight: 1.6, position: "relative" }}>{subtitle}</p>
  ...
  return (
    <aside className="whistle-sidebar" style={{
      ...
      <div style={{ padding: "0 20px", marginBottom: 28, display: "flex", alignItems: "center", gap: 10 }}>
        <div style={{ width: 38, height: 38, borderRadius: 12, background: `linear-gradient(135deg, ${c.green500}, ${c.emerald600})`, display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontWeight: 800, fontSize: 16, boxShadow: "0 2px 8px rgba(22,163,74,0.3)" }}>W</div>
        <div style={{ display: "flex", flexDirection: "column" }}>
          <span style={{ fontSize: 18, fontWeight: 800, color: c.slate800, letterSpacing: -0.5, lineHeight: 1.1 }}>Whistle Coach</span>
          <span style={{ fontSize: 10, fontWeight: 500, color: c.slate400, letterSpacing: 0.5, textTransform: "uppercase" }}>Practice Planner</span>
        </div>
      </div>
  ...
  return (
    <div>
      <PageHero gradient={cfg.heroGradient}
        title={`Welcome back, Coach ${cfg.emoji}`}
        subtitle={`Ready to build your next great ${sport.toLowerCase()} practice? Generate an AI-powered plan, explore ${(drillsBySport[sport] || []).length}+ drills, or manage your roster.`}
    ...
    <div>
      ...
      {filtered.length === 0 ? (
        <div style={{ ...cardStyle, padding: "60px 40px", textAlign: "center" }}>
          ...
          <div style={{ width: 56, height: 56, borderRadius: 16, background: c.slate100, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}><Search size={24} color={c.slate400} /></div>
          <h3 style={{ fontSize: 18, fontWeight: 700, color: c.slate700, marginBottom: 6 }}>No drills found</h3>
          <p style={{ fontSize: 14, color: c.slate500, maxWidth: 300, margin: "0 auto" }}>Try adjusting your filters, changing the age group, or searching for a different term</p>
        </div>
      ) : (
...
const DRILL_VIDEOS = {
  // ── Soccer ────────────────────────────────────────────────────────────
  w1: { title: "Fun Tag Dribbling Warm-Up", ytId: "xowFLa-nNVg" },
  w2: { title: "Rondo Explained — 4v1 Drill", ytId: "hTZX9_8NA3Y" },
  w3: { title: "Sharks & Minnows Dribbling", ytId: "d_4T1DMBy1A" },
  t1: { title: "Perfect Passing Technique", ytId: "rEXXlrsnKUo" },
  t2: { title: "Cone Dribbling Skills", ytId: "vnngDOCy9C8" },
  t3: { title: "Youth Shooting Technique", ytId: "DO0_76zVqqs" },
  t4: { title: "First Touch Training", ytId: "0kGgL_aglEE" },
  t5: { title: "Ball Mastery Drills", ytId: "CosG13seo3o" },
  t6: { title: "1v1 Attacking Moves", ytId: "ke2UJBmeJAc" },
  ta1: { title: "3v1 Possession Drill", ytId: "VeGU4bF5rU0" },
  ta2: { title: "Small-Sided Game Tips", ytId: "RtiRDRWaXNY" },
  ta3: { title: "Defensive Shape Training", ytId: "gHVXwse0MU8" },
  g1: { title: "Running a Great Scrimmage", ytId: "VV8DRg3mQqs" },
  gk1: { title: "Goalkeeper Training for Kids", ytId: "BHsPdQ7EnZM" },
  gk2: { title: "Goalkeeper Reaction & Angles", ytId: "58eZb2reR94" },
  sp1: { title: "Corner Kick Set Pieces", ytId: "KcJEITSMxLY" },
  sp2: { title: "Attacking Corner Routines", ytId: "40i5EZ26gGQ" },
  w4: { title: "Dynamic Stretching for Soccer", ytId: "nPZH0g5bz6w" },
  w5: { title: "Chase the Cones Relay Race", ytId: "3fmzVhOmmLE" },
  w8: { title: "Pass & Follow Circle Warm-Up", ytId: "TUd-xDbmGv4" },
  w9: { title: "1v1 Warm-Up Duels", ytId: "eD2T5GXeaYE" },
  w11: { title: "Red Light Green Light Dribbling", ytId: "RK3v_KBi99M" },
  w12: { title: "Cops & Robbers Soccer Game", ytId: "GmhXBPMUNys" },
  t7: { title: "T-Cone Dribbling Drill", ytId: "y3veoqA2ICo" },
  t9: { title: "Wall Pass Combination Play", ytId: "Q7hROm8fMZ8" },
  t10: { title: "Crossing & Finishing Drill", ytId: "sxjgSFfPoo8" },
  t11: { title: "Receive & Turn Under Pressure", ytId: "oBT0UlLlFlQ" },
  t15: { title: "Gate Passing Drill", ytId: "6RGJBj1tNC8" },
  t18: { title: "Volley Finishing Technique", ytId: "Q2XZBfJWwos" },
  t20: { title: "Receiving Under Pressure", ytId: "hoyShjtcR8w" },
  ta4: { title: "Transition Game — Win & Attack", ytId: "9laJGyCZ0I4" },
  ta5: { title: "Rondo 4v2 Possession", ytId: "0oUvF7Wp6A8" },
  ta6: { title: "Four Goal Game", ytId: "c_nq0Ka_RWs" },
  ta7: { title: "Pressing Triggers Drill", ytId: "P05XSNR59Wc" },
  ta8: { title: "Overload Attack 3v2", ytId: "VeGU4bF5rU0" },
  ta12: { title: "Numbers Game — Transition Fun", ytId: "xowFLa-nNVg" },
  ta13: { title: "1v1 Defensive Jockeying", ytId: "gHVXwse0MU8" },
  ta17: { title: "Build from the Back", ytId: "RtiRDRWaXNY" },
  g2: { title: "Conditioned Scrimmage Ideas", ytId: "VV8DRg3mQqs" },
  g4: { title: "King of the Ring Dribbling", ytId: "d_4T1DMBy1A" },
  gk3: { title: "GK Crosses & High Balls", ytId: "58eZb2reR94" },
  gk5: { title: "GK Footwork & Reactions", ytId: "BHsPdQ7EnZM" },
  gk6: { title: "1v1 Shot Stopping for GKs", ytId: "KcJEITSMxLY" },
  c1: { title: "Cool-Down Stretching Routine", ytId: "CosG13seo3o" },
  // ── Basketball (IDs 101-154) ──────────────────────────────────────────
  "101": { title: "3-Man Weave", ytId: "glc6aHFYHNk" },
  "102": { title: "Mikan Drill", ytId: "YBQyynRRejg" },
  "103": { title: "Shell Defense", ytId: "mtA7p5IbKLI" },
  "104": { title: "Spot Shooting", ytId: "1RQPTBFduwc" },
  "105": { title: "Dynamic Warm-Up Lines", ytId: "HB7X9YGCH3M" },
  "106": { title: "Dribble Knockout", ytId: "5VZJubR6eKU" },
  "107": { title: "Cone Dribbling Course", ytId: "ZDYOiKPspNc" },
  "108": { title: "Stationary Ball Handling", ytId: "Wj91zTrSN5w" },
  "109": { title: "Partner Passing on the Move", ytId: "ivKZ5ea5QCY" },
  "110": { title: "Star Passing", ytId: "4wkJ8JxPy_A" },
  "111": { title: "Form Shooting", ytId: "8R219feDhGk" },
  "112": { title: "Layup Lines", ytId: "Tm7N2HU4noQ" },
  "113": { title: "Zig-Zag Defensive Slides", ytId: "ya2k4daISrw" },
  "114": { title: "Closeout Drill", ytId: "bdWoZkZYD0s" },
  // ── Baseball (IDs 201-243) ────────────────────────────────────────────
  "201": { title: "Soft Toss Hitting", ytId: "6Q9V5CvTpK0" },
  "202": { title: "Ground Ball Circuit", ytId: "4WBsPN7F7gc" },
  "203": { title: "Throwing Progression", ytId: "77r6mWAUecA" },
  "205": { title: "Tee Work Stations", ytId: "UeJpXF55kvs" },
  "206": { title: "Front Toss / Flips", ytId: "Ml7n2v2mi5s" },
  "207": { title: "Pop Fly Communication", ytId: "tvjqlF0o5Fk" },
  "208": { title: "Outfield Relay Throws", ytId: "OTP9eUBsqmk" },
  "209": { title: "Pitching Mechanics Drill", ytId: "RmFSIUWnAEI" },
  "212": { title: "Batting Practice Rounds", ytId: "fPRAqPcEPYA" },
  // ── Football (IDs 301-346) ────────────────────────────────────────────
  "301": { title: "Route Running Tree", ytId: "DHVT0R1njzM" },
  "303": { title: "Agility Ladder & Cones", ytId: "EIpeeBPSLC4" },
  "305": { title: "Catch & Throw Progression", ytId: "v8wRsdkRWk4" },
  "306": { title: "Hot Hands Catching", ytId: "U0dURJnqK3U" },
  "307": { title: "Handoff Exchange", ytId: "3dHooHJfVGs" },
  "309": { title: "Flag Pull / Tackling Angles", ytId: "gMi8VioQuEM" },
  "310": { title: "Backpedal & Break", ytId: "SZ2GmkIQ3ao" },
  "311": { title: "7-on-7 Passing Scrimmage", ytId: "DjKcZrBKTco" },
};
    ...
    <div>
      ...
      {upcoming.length === 0 && past.length === 0 && !showForm && (
        <div style={{ ...cardStyle, padding: 56, textAlign: "center" }}>
          <div style={{ width: 64, height: 64, borderRadius: 20, background: `linear-gradient(135deg, ${c.blue50}, ${c.blue100})`, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}><Calendar size={28} style={{ color: c.blue500 }} /></div>
          <h3 style={{ fontSize: 18, fontWeight: 700, color: c.slate700, marginBottom: 8 }}>No events yet</h3>
          <p style={{ fontSize: 14, color: c.slate400, maxWidth: 320, margin: "0 auto 20px", lineHeight: 1.5 }}>Schedule practices, games, and team events to keep everyone organized and on time</p>
          <button onClick={() => setShowForm(true)} style={{ padding: "10px 24px", borderRadius: 10, border: "none", background: c.blue500, color: c.white, fontWeight: 600, fontSize: 14, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 6 }}><Plus size={16} /> Add First Event</button>
        </div>
      )}
  ...
  return (
    <div>
      ...
      {messages.length === 0 && !showCompose && (
        <div style={{ ...cardStyle, padding: 56, textAlign: "center" }}>
          <div style={{ width: 64, height: 64, borderRadius: 20, background: `linear-gradient(135deg, ${c.green50}, ${c.emerald100})`, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}><Volume2 size={28} style={{ color: c.green500 }} /></div>
          <h3 style={{ fontSize: 18, fontWeight: 700, color: c.slate700, marginBottom: 8 }}>No messages yet</h3>
          <p style={{ fontSize: 14, color: c.slate400, maxWidth: 320, margin: "0 auto 20px", lineHeight: 1.5 }}>Keep your team in the loop with announcements, reminders, and game-day updates</p>
          <button onClick={() => setShowCompose(true)} style={{ padding: "10px 24px", borderRadius: 10, border: "none", background: c.green600, color: c.white, fontWeight: 600, fontSize: 14, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 6 }}><Plus size={16} /> Send First Message</button>
        </div>
      )}
  ...
  return (
    <>
      <style>{`
        ...
        .whistle-page-enter {
          animation: whistleFadeIn 0.3s ease-out both;
        }
        ...
        <main ref={mainRef} tabIndex={-1} role="main" aria-label="Page content" style={{
          ...
          {isMobile && (
            <div className="whistle-mobile-header" style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, paddingTop: 4 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{ width: 28, height: 28, borderRadius: 8, background: `linear-gradient(135deg, ${c.green500}, ${c.emerald600})`, display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontWeight: 800, fontSize: 12, boxShadow: "0 2px 6px rgba(22,163,74,0.25)" }}>W</div>
                <span style={{ fontSize: 16, fontWeight: 700, color: c.slate800, letterSpacing: -0.3 }}>Whistle Coach</span>
              </div>
            </div>
          )}
          <ErrorBoundary key={page}><div className="whistle-page-enter" key={page}>{pages[page]}</div></ErrorBoundary>
          <footer style={{ marginTop: 48, paddingTop: 24, borderTop: `1px solid ${c.slate200}`, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12, paddingBottom: 24 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ width: 22, height: 22, borderRadius: 6, background: `linear-gradient(135deg, ${c.green500}, ${c.emerald600})`, display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontWeight: 800, fontSize: 10 }}>W</div>
              <span style={{ fontSize: 12, fontWeight: 600, color: c.slate400 }}>Whistle Coach</span>
              <span style={{ fontSize: 11, color: c.slate300 }}>v2.1</span>
            </div>
            <span style={{ fontSize: 11, color: c.slate300 }}>Built for coaches who care about development</span>
          </footer>
        </main>
